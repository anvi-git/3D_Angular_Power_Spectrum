...
function galaxy_prefactor(
    ...
    plot(z, x, label = L"z(\chi)", xlabel = L"z", 
         ylabel = L"\chi [Mpc/h]", legend = :topleft; plot_style...
    ...
    plot(z, bz_array, label = "bias", xlabel = L"z", 
         ylabel = L"b(z)", legend = :topleft; plot_style...)
    ...
    plot(z, D_growth_array, label = "growth array", xlabel = L"z", 
         ylabel = L"D(z)", legend = :topleft; plot_style...)
    ...
    ylabel = L"H(z) [Mpc/h]/c", legend = :topleft; plot_style...)
